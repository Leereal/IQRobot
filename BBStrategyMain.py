...
# +|========================STRATEGY BEGIN=========================|+#
    ...
    while True:            
        try: 
            close = getClosePrices(symbol,timeframe)        
            upperband, middleband, lowerband = BBANDS(close*100000, timeperiod=20, nbdevup=2.0, nbdevdn=2.0, matype=0) 
...
if __name__ == '__main__':
    risk_management = {
    "maximum_risk_target":float(500), #Balance you want to reach due to profit
    ...
    account_type    = "REAL" # / REAL / PRACTICE /TOURNAMENT /TOURNAMENT APRIL TOURNAMENT/ IQ LAUNCH /RAMADAN
    stake           = float(1)
    expiration      = int(1)
    timeframe       = int(60)
    ...
    symbols = ["EURUSD","EURJPY","EURGBP","GBPUSD","GBPJPY","USDJPY","XAUUSD","AUDJPY"]
